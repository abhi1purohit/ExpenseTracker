...
dataentery_frame_bg = 'grey'
buttons_frame_bg = 'silver'
hlb_btn_bg = 'silver'
lbl_font = ('Georgia', 13)
...
root = Tk()
root.title("Abhishek's Expense Tracker")
root.geometry('1200x550')
root.resizable(0, 0)
Label(root, text=" ABHISHEK'S EXPENSE TRACKER ", font=('Noto Sans CJK TC', 15, 'bold'), bg=hlb_btn_bg).pack(side=TOP, fill=X)
